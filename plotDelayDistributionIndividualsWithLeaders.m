                    ...
                    if any(any(delayDist))
                        ...
                        for cellIdx=plotOrder'
                            if ~all(isnan(delayDist(cellIdx,:)))
                                ...
                                plotColor = [0 0 0 asymmetries(cellIdx)]*(1 - sqrt(asymmetries(cellIdx))) ...
                                    + [1 0 0 asymmetries(cellIdx)]*sqrt(asymmetries(cellIdx));
...
%                         ax.YTickLabel{2} = 'P';
        ...
        filename = ['manuscript/figures/diagnostics/delayDistIndividuals_T' num2str(T) '_N' num2str(N) ...
            '_Nl' num2str(Nl) '_L' num2str(L) '_a' num2str(alpha,precision) ...
