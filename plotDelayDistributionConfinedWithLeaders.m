...
%             plotCurrent = 0;
            for repCtr = 1:numRepeats
                ...
                filename = ['results/' 'T' num2str(T,precision) '_N' num2str(N,precision)...
                        ...
                        '_selfAlign' num2str(false) '_run' num2str(repCtr) '.mat'];
                out = load(filename);
                % discard burn-in
                cells = out.cells(:,:,burnIn:end);
...
%     system(['rm ' filename '.eps']);
    ...
    %%
    save(['delayCorrResultsConfined_N' num2str(N) '_Nl' num2str(Nl) '_L' num2str(L,precision) '.mat'],...
